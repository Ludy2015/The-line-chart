...
- (void)viewDidLoad {
    ...
    barChart.topic = @"xx小学各年级男女人数";//表头
    barChart.topicColor = ZFYellow;//topic字体颜色
    barChart.unit = @"人";//单位
   
    barChart.isAnimated = YES;
    barChart.isResetAxisLineMinValue = NO;
    barChart.isShadowForValueLabel = YES;
